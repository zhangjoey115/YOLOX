...
def make_parser():
    ...
    parser.add_argument(
        ...
        "--path", default="/home/zjw/workspace/AI/perception/YOLOX/models/lane/image/000349.jpg", help="path to images or video"
    )
...
class Predictor(object):
    ...
    def inference(self, img):
        ...
        with torch.no_grad():
            ...
            output_data = torch.argmax(output_data, 1).squeeze(0)
            print(output_data.shape)

            image_output = output_data*100
            # print("outputs = {}".format(outputs))
            logger.info("Infer time: {:.4f}s".format(time.time() - t0))
        return image_output, img_info
