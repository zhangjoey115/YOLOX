...
if __name__ == "__main__":
    ...
    model = quantize_model(exp, ckpt_file, data_loader, num_pics=100)
    ...
    file_name = os.path.join(file_dir, 'lane_ptq_t100_p9999.pth')
    torch.save(model.state_dict(), file_name)

    # export onnx
    batch_size = 1
    onnx_name = os.path.join(file_dir, 'lane_ptq_t100_p9999.onnx')
