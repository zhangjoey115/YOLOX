"""
    Info:   Crop image bbox area specified in xml label file. 
    
    Usage:  Generate file like 38741_1_pl5.jpg, 38741_2_ph3.2.jpg
            According new xml label file could be generated by script label_anno_crop.py
    Author: zjw
    Date:   2021-09-10
"""
import os
...
def crop_one_img_by_label(img_path, label_list, save_dir):
    ...
    for i, label in enumerate(label_list):
        ...
        bbox = label["bbox"]
        sub_thrd = threading.Thread(target=crop_save_one_img(img, bbox, out_path, resize_wid=128))
        sub_thrd.start()
...
if __name__ == "__main__":
    ...
    if option == 'CROP_SIGNS':
        ...
        img_save_dir = '/home/zjw/workspace/DL_Vision/TSR/YOLOX/datasets/tt100k_part/tt100k2021_crop_128/train/'
        ...
        # img_save_dir = '/home/zjw/workspace/DL_Vision/TSR/YOLOX/datasets/tt100k_part/tt100k2021_crop_128/test/'
