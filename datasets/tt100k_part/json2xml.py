...
subprocess.call("mkdir -p xmlLabel/train",  shell=True)
subprocess.call("mkdir -p xmlLabel/test",  shell=True)

json_path = "annotations_all.json"
annos = json.loads(open(json_path).read())

trainIds = getDirId("/home/zjw/workspace/DL_Vision/dataset/TT100k/tt100k_2021/train/")
testIds = getDirId("/home/zjw/workspace/DL_Vision/dataset/TT100k/tt100k_2021/test/")
