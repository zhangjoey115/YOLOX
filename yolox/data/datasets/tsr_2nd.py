...
class AnnotationTransform(object):
    ...
    def __init__(self, class_to_ind=None, keep_difficult=True):
        self.class_to_ind = class_to_ind or dict(
            zip(TSR_2ND_CLASSES, range(len(TSR_2ND_CLASSES)))
        )
...
class TSR_2ND_Detection(Dataset):
    ...
    def __init__(
        self,
        data_dir,
        image_sets=[("tsr_2nd", "train")],
        img_size=(100, 100),
        preproc=None,
        target_transform=AnnotationTransform(),
        dataset_name="tsr_2nd",
        cache=False,
    ):
    ...
    def _write_voc_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(TSR_2ND_CLASSES):
            cls_ind = cls_ind
    ...
    def _do_python_eval(self, output_dir="output", iou=0.5):
        ...
        if output_dir is not None and not os.path.isdir(output_dir):
            os.mkdir(output_dir)
        for i, cls in enumerate(TSR_2ND_CLASSES):
