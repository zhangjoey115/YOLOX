...
class TSR_2ND_Evaluator:
    ...
    def evaluate_prediction(self, data_dict, statistics):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            mAP50 = self.dataloader.dataset.evaluate_detections(
                all_boxes, tempdir
            )
            logger.info("val/mAP50: {:.4f}, val/mAP50_95: {:.4f}".format(mAP50, mAP50))
            return mAP50, mAP50, info
