...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.use_add:            
            y = self.quantizer2(y) + self.quantizer(x)
            # y = y + x
        return y
...
class Focus(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, ksize=1, stride=1, act="silu"):
        ...
        self.conv1 = BaseConv(in_channels, out_channels//2, 3, 2, 1, act=act)    # for OD
        self.conv2 = BaseConv(out_channels//2, out_channels, 3, 1, 1, act=act)
        # self.conv1 = BaseConv(in_channels, out_channels//2, 3, 2, act=act)    # for tsr3
