...
from .network_blocks_od import BaseConv, CSPLayer, DWConv, Focus, ResLayer, SPPBottleneck
...
class CSPDarknet(nn.Module):
    def __init__(
        ...
        self.dark5 = nn.Sequential(
            ...
            SPPBottleneck(base_channels * 16, base_channels * 16, activation=act, quant=True),
            CSPLayer(
                base_channels * 16,
                base_channels * 16,
                n=base_depth,
